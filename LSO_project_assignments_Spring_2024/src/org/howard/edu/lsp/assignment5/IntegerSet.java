...
public class IntegerSet {
    ...
    /**
     * Modifies this set to contain only the elements that are not present in the specified set.
     * Essentially, this set becomes the complement of itself relative to the specified set.
     * @param anotherSet the IntegerSet to compare with for the complement.
     */
    public void complement(IntegerSet anotherSet) {
        List<Integer> complementElements = new ArrayList<>(anotherSet.elements);
        complementElements.removeAll(this.elements);
        this.elements.clear();
        this.elements.addAll(complementElements);
    }
